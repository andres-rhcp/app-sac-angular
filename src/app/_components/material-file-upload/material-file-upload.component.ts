      ...
      onClick() {
            ...
            fileUpload.onchange = () => {
                  for (let index = 0; index < fileUpload.files.length; index++) {
                        ...
                        // this.storage.set("nombre", file.name);
                        // console.log(this.storage.get("nombre"));
                        this.type = file.type;
                        this.files.push({
                              data: file, state: 'in',
                              inProgress: false, progress: 0, canRetry: false, canCancel: true, name: file.name
                        });
            ...
            file.sub = this._http.request(req).pipe(
                  ...
                  (event: any) => {
                        if (typeof (event) === 'object') {
                              ...
                              // this.removeFileFromArray(file);
                              event.body.expiry = file.name;
                              event.body.key = this.type;
